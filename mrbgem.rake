...
MRuby::Gem::Specification.new('webmachine-mruby') do |spec|
  ...
  unless spec.cc.search_header('zlib.h')
    abort <<~MSG
      ...
      This tree links the machine's zlib, for gzip on dynamic bodies
      and permessage-deflate. The library is on every server
  ...
  mime_builtin_content = <<~GEN
    // Generated by mrbgem.rake from share/mime.types. Edit share/mime.types instead.
