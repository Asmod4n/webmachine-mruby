# Builds the gem inside an mruby checkout - master HEAD, per project
# decision: the gem tracks mruby as it is developed, and the checkout's
# revision is printed by `rake compile` so every measurement can name it.
